																	...
																	(suggestionParamList, rowIndex) => ((
																		<TableRow key={rowIndex}>
																			...
																			<TableCell align="center">
																				<Button variant="contained" color="primary" onClick={() => this.drawVisualization(viz.suggestionInfo.vizParams[`${rowIndex}`], viz.vizName)}>Draw</Button>
																			</TableCell>
																		</TableRow>
																	))
																)
